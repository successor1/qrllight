...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.transaction_table.setGeometry(QtCore.QRect(0, 0, 811, 301))
        ...
        self.transaction_table.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.transaction_table.setVerticalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.transaction_table.setVerticalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.transaction_table.setVerticalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.transaction_table.setVerticalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.transaction_table.setVerticalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.transaction_table.setVerticalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.transaction_table.setVerticalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.transaction_table.setVerticalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        self.transaction_table.setVerticalHeaderItem(9, item)
        item = QtWidgets.QTableWidgetItem()
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "qrllight wallet v1.4"))
        item = self.transaction_table.verticalHeaderItem(0)
        item.setText(_translate("mainWindow", "1"))
        item = self.transaction_table.verticalHeaderItem(1)
        item.setText(_translate("mainWindow", "2"))
        item = self.transaction_table.verticalHeaderItem(2)
        item.setText(_translate("mainWindow", "3"))
        item = self.transaction_table.verticalHeaderItem(3)
        item.setText(_translate("mainWindow", "4"))
        item = self.transaction_table.verticalHeaderItem(4)
        item.setText(_translate("mainWindow", "5"))
        item = self.transaction_table.verticalHeaderItem(5)
        item.setText(_translate("mainWindow", "6"))
        item = self.transaction_table.verticalHeaderItem(6)
        item.setText(_translate("mainWindow", "7"))
        item = self.transaction_table.verticalHeaderItem(7)
        item.setText(_translate("mainWindow", "8"))
        item = self.transaction_table.verticalHeaderItem(8)
        item.setText(_translate("mainWindow", "9"))
        item = self.transaction_table.verticalHeaderItem(9)
