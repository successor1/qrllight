...
class Ui_mainWindow(object):
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.ots_warning_label.setText(_translate("mainWindow", "<html><head/><body><p><span style=\" font-size:9pt; font-weight:600;\">OTS Key Index Warning</span></p><p><span style=\" font-size:9pt; font-style:italic;\">The OTS Key Index in the field above is estimated based on data provided by the QRL node you\'re connected to. </span></p><p><span style=\" font-size:9pt; font-style:italic;\">You should never re-use the same OTS Key for more than 1 transaction.</span></p><p><span style=\" font-size:9pt; font-style:italic;\">If you are unsure, it is safest to write down all used OTS Key Indexes, and store them in a safe place. </span></p><p><span style=\" font-size:9pt;\">With your last key you must empty your wallet. </span></p><p><span style=\" font-size:9pt;\">If you use all of your OTS Key Indexes with funds in the wallet, these funds will be </span><span style=\" font-size:9pt; font-weight:600;\">lost FOREVER!</span></p></body></html>"))
