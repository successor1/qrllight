...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("images/logocircle.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.activity_window = QtWidgets.QTabWidget(self.home_tab)
        self.activity_window.setObjectName("activity_window")
        self.reddit_tab = QtWidgets.QWidget()
        self.reddit_tab.setObjectName("reddit_tab")
        self.activity_window.addTab(self.reddit_tab, "")
        self.twitter_tab = QtWidgets.QWidget()
        self.twitter_tab.setObjectName("twitter_tab")
        self.activity_window.addTab(self.twitter_tab, "")
        self.blog_tab = QtWidgets.QWidget()
        self.blog_tab.setObjectName("blog_tab")
        self.activity_window.addTab(self.blog_tab, "")
        self.horizontalLayout.addWidget(self.activity_window)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("images/tab_home.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.inner_window.addTab(self.home_tab, icon1, "")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("images/tab_history.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.inner_window.addTab(self.history_tab, icon2, "")
        ...
        self.amount_label.setGeometry(QtCore.QRect(20, 80, 55, 16))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("images/tab_send.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.inner_window.addTab(self.send_tab, icon3, "")
        self.receive_tab = QtWidgets.QWidget()
        self.receive_tab.setObjectName("receive_tab")
        self.public_label = QtWidgets.QLabel(self.receive_tab)
        self.public_label.setGeometry(QtCore.QRect(330, 20, 161, 16))
        self.public_label.setObjectName("public_label")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("images/tab_receive.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.inner_window.addTab(self.receive_tab, icon4, "")
        ...
        self.actionQRL_paper = QtWidgets.QAction(mainWindow)
        self.actionQRL_paper.setObjectName("actionQRL_paper")
        ...
        self.menuHelp.addAction(self.actionQRL_paper)
        ...
        self.activity_window.setCurrentIndex(0)
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "QRL Wallet v0.0.1"))
        self.activity_window.setTabText(self.activity_window.indexOf(self.reddit_tab), _translate("mainWindow", "Reddit"))
        self.activity_window.setTabText(self.activity_window.indexOf(self.twitter_tab), _translate("mainWindow", "Twitter"))
        self.activity_window.setTabText(self.activity_window.indexOf(self.blog_tab), _translate("mainWindow", "Blog"))
        self.inner_window.setTabText(self.inner_window.indexOf(self.home_tab), _translate("mainWindow", "Home"))
        ...
        self.public_label.setText(_translate("mainWindow", "Your Public QRL Address"))
        ...
        self.actionQRL_paper.setText(_translate("mainWindow", "QRL paper"))
